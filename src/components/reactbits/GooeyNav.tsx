    ...
    <>
      ...
      <style>
        {`
          ...
          /*
           * Metin kopyası, aktif maddenin üzerine bindirilip rengini animasyonla
           * değiştirmek için var. Bizim kurulumda madde rengi zaten li.active ile
           * değiştiği için kopya yalnızca ikinci bir gölge metin oluşturuyordu.
           */
          .effect.text {
            display: none;
          }
